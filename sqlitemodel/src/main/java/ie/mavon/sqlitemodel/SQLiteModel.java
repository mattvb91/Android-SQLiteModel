...
import ie.mavon.sqlitemodel.Exception.DatabaseNotFoundException;

/**
 * SQLiteModel
 * Handle all core functionality like retrieving/saving a model
 */
abstract public class SQLiteModel implements BaseColumns, Serializable {
    ...
    protected static SQLiteOpenHelper _db;

    public static SQLiteOpenHelper getDbHandler() {
        return _db;
    }
    ...
    public static void setDB(SQLiteOpenHelper db) {
        _db = db;
    }
    ...
    public LinkedHashMap<String, String> getItemsForSelect(String fieldName) {
        ...
        String query = "SELECT " + _ID + ", " + fieldName + " FROM " + getTableName() + " ORDER BY " + fieldName + " ASC";
    ...
    public SQLiteModel getItem(Pair<String, String> filter) {
